    ...
    <View style={{flex: 1}}>
      <View style={{flex: 1, backgroundColor: 'white'}}>
        ...
        {orders.length == 0 ? ( 
          ...
          <Text style={{color: 'black', fontSize: 18, fontWeight: '500', marginRight:"50%"}}> No Orders</Text>
          </View>):( 
          <View
          style={{
            height: '100%',
              ...
              renderItem={({item}) => (
                <View
                  style={{
                   ...
                   <TouchableOpacity
                    onPress={() =>
                      navigation.navigate('UserOrders', {order: item})
                    }
                    style={{
                      borderWidth: 1,
                      borderColor: '#999',
        ...
        <View style={{marginTop:20, padding:10}}>
          <TouchableOpacity
              ...
              <Text style={[styles.text, styles['text_Primary']]}>Go Back</Text>
            </TouchableOpacity>
        </View>
      </View>
    </View>
